...
class ChecklistCategory(db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'), nullable=False)
    items = db.relationship('ChecklistItem', backref='checklist_category', lazy=True)
...
class TradingPlan(db.Model):
    ...
    market_conditions = db.Column(db.Text, nullable=False)
    goals = db.Column(db.Text, nullable=False)
    risk_management = db.Column(db.Text, nullable=False)
    entry_exit_criteria = db.Column(db.Text, nullable=False)
    trade_setup = db.Column(db.Text, nullable=False)
    review_notes = db.Column(db.Text, nullable=False)
    news_events = db.Column(db.Text, nullable=False)
    premarket_routine = db.Column(db.Text, nullable=False)
    timeframe = db.Column(db.Text, nullable=False)
    market_type = db.Column(db.Text, nullable=False)
    entries = db.Column(db.Text, nullable=False)
    stop_loss = db.Column(db.Text, nullable=False)
    take_profit = db.Column(db.Text, nullable=False)
    ...
    image6 = db.Column(db.String(255), nullable=True)